...
public interface IMemoryQueryResultReranker
{
    ...
    IAsyncEnumerable<MemorySearchResult> Rerank(IAsyncEnumerable<MemorySearchResult> results);

    IAsyncEnumerable<MemorySearchResult> Rerank(IEnumerable<MemorySearchResult> results);
}

...
namespace Synaptic.NET.Domain.Migrations
{
    ...
    [Migration("20250907104855_ApiKeyAuthenticationPropertyOnUsers")]
    partial class ApiKeyAuthenticationPropertyOnUsers
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Synaptic.NET.Domain.Resources.Management.ApiKey", b =>
                {
                    ...
                    b.HasAnnotation("Relational:JsonPropertyName", "api_keys");
                });

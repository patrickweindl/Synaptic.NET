...
namespace Synaptic.NET.Domain.Migrations
{
    ...
    partial class SynapticDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Synaptic.NET.Domain.Resources.Group", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
            ...
            modelBuilder.Entity("Synaptic.NET.Domain.Resources.GroupMembership", b =>
                {
            ...
            modelBuilder.Entity("Synaptic.NET.Domain.Resources.Memory", b =>
                {
            ...
            modelBuilder.Entity("Synaptic.NET.Domain.Resources.MemoryStore", b =>
                {
                    b.Property<Guid>("StoreId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
            ...
            modelBuilder.Entity("Synaptic.NET.Domain.Resources.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
            ...
            modelBuilder.Entity("Synaptic.NET.Domain.Resources.GroupMembership", b =>
                {
                    b.HasOne("Synaptic.NET.Domain.Resources.Group", "Group")
                        .WithMany("Memberships")
                        .HasForeignKey("GroupId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Synaptic.NET.Domain.Resources.User", "User")
                        .WithMany("Memberships")
            ...
            modelBuilder.Entity("Synaptic.NET.Domain.Resources.Memory", b =>
                {
                    b.HasOne("Synaptic.NET.Domain.Resources.MemoryStore", "Store")
                        .WithMany("Memories")
            ...
            modelBuilder.Entity("Synaptic.NET.Domain.Resources.MemoryStore", b =>
                {
                    b.HasOne("Synaptic.NET.Domain.Resources.Group", "OwnerGroup")
                        .WithMany("Stores")
                        .HasForeignKey("GroupId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Synaptic.NET.Domain.Resources.User", "OwnerUser")
                        .WithMany("Stores")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade);

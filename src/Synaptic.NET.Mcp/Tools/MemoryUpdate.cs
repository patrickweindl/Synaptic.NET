...
/// <summary>
/// Provides tools for memory updates, using Dependency Injection for the individual methods.
/// </summary>
[McpServerToolType]
[PublicAPI]
public static class MemoryUpdate
{
    ...
    public static async Task<string> ReplaceMemoryAsync(
        ...
        [Description("The updated title of the memory to update. If it does not exist, a new memory will be created.")]
        string memoryTitle,
        ...
        IMemoryProvider memoryProvider)
    {
        ...
        var replacement = await memoryProvider.UpdateMemoryEntryAsync(memoryIdentifier, newMemory);
